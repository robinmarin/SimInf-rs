...
implementation and for demonstrating that the Rust port produces equivalent results to the
original, but with the flexibility of Rust's cross-compilation targets.
...
Rscript tests/validation/generate.R
```
